			var request_url = "https://api.worldweatheronline.com/premium/v1/weather.ashx?key=7171412a7c7a4c83af6125037250212&q=Sorochinsk&tp=24&format=json";
			...
			if (choice == "Blowing snow" || choice == "Moderate or heavy snow showers" || choice == "Patchy moderate snow" || choice == "Moderate snow" || choice == "Heavy snow" || choice == "Blizzard" || choice == "Light snow" || choice == "Light sleet" || choice == "Light snow showers"){
					...
					if(choice == "Moderate rain" || choice=="Light freezing rain" || choice == "Patchy rain nearby"){
						img_1.src = rain_path;
					}
				...
				function choose_weather_17(choice){
					if (choice == "Blowing snow" ||choice == "Moderate or heavy snow showers" || choice == "Patchy moderate snow" ||choice == "Moderate snow" || choice == "Heavy snow" || choice == "Light snow" || choice == "Light sleet" || choice == "Blizzard" || choice == "Light snow showers"){
