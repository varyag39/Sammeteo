			...
			if (choice == "Moderate or heavy snow showers" || choice == "Patchy moderate snow" || choice == "Moderate snow" || choice == "Heavy snow" || choice == "Blizzard" || choice == "Light snow" || choice == "Light sleet" || choice == "Light snow showers"){
						img_1.src = snow_path;
					}
				...
				function choose_weather_2(choice){
					if (choice == "Moderate or heavy snow showers" || choice == "Patchy moderate snow" ||choice == "Moderate snow" || choice == "Blizzard" || choice == "Light snow" || choice == "Light sleet" || choice == "Light snow showers" || choice == "Heavy snow" || choice == "Moderate or heavy snow showers" || choice == "Patchy moderate snow"){
						img_2.src = snow_path;
					}
					if (choice == "Overcast " || choice == "Cloudy "){
				...
				function choose_weather_3(choice){
					if (choice == "Moderate or heavy snow showers" || choice == "Patchy moderate snow" ||choice == "Moderate snow" || choice == "Blizzard" || choice == "Light snow" || choice == "Light sleet" || choice == "Light snow showers" || choice == "Heavy snow"){
						img_3.src = snow_path;
					}
					if (choice == "Overcast " || choice == "Cloudy "){
				...
				function choose_weather_17(choice){
					if (choice == "Moderate or heavy snow showers" || choice == "Patchy moderate snow" ||choice == "Moderate snow" || choice == "Heavy snow" || choice == "Light snow" || choice == "Light sleet" || choice == "Blizzard" || choice == "Light snow showers"){
